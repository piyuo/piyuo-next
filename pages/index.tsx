...
export default function Home() {
  ...
  const [t, setT] = useState<{ title?: string; description?: string; switchLang?: string }>({});

  // Load translation on lang change
  useEffect(() => {
    locales[lang]().then((mod) => setT(mod.default || mod));
  }, [lang]);
  ...
  return (
    ...
    >
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <p className="text-lg mb-8 max-w-xl text-center sm:text-left">
          {t.description}
        </p>
        <button
        ...
        <ol className="list-inside list-decimal text-sm/6 text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2 tracking-[-.01em]">
            Hi, I am here !!! Get started by editing{" "}
