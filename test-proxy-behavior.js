// Test script to verify current proxy behavior for non-locale paths
...
const enResponse = proxy(enRequest);
...
const zhResponse = proxy(zhRequest);
...
const frResponse = proxy(frRequest);
